...
Mollweide_projection(HII_contrasted)
...
pdf(file = paste0("./supplementaries/HF_map.pdf"), height = 5, width = 5)

internal_margins <- par()$mar
par(mar = c(3.1, 3.1, 2.7, 1.6))

map_indices_Mollweide(x = HII_contrasted_Mollweide,
                      main_title = "Human Footprint",
...
# text(x = -2700, y = 0, labels = "-100", cex = 1.4)  # Add the contrast on the scale
