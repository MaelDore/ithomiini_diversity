...
##### Script 31: Ring range ~ Ring size ######

# Investigate relationship between ring range (1/rarity) and ring size (number of species/OMU)

###

# Input:
   # Ring probability stack from script 13
   # 

# Output:
   # Summary table for rings updated with ring size, range, rarity, ...
   # Correlation tests for Ring range ~ Ring size
   # Scatterplots for Ring range ~ Ring size 
       # Range as total ring range
       # Range as normalized ring range (0 to 1)
       # Range as the mean range of species belonging to the ring
...
### 4/ Test for correlation between size and range ####
