...
##### Script 14b: Compute and plot extra indices maps #####
...
# Inputs:
   # Stack of OMU 'probability' of presence from script 11
...
# 11.2/ Project stuff ###
Mollweide_projection(sp.diversity)
Mollweide_projection(ring.diversity)
Mollweide_projection(ED)
Mollweide_projection(max_ring_size)
...
pdf(file = paste0("./supplementaries/Bonus_index_maps.pdf"), height = 9, width = 9)
...
# A/ Shannon's species diversity
map_indices_Mollweide(x = sp.diversity_Mollweide,
...
# B/ Shannon's mimicry diversity
map_indices_Mollweide(x = ring.diversity_Mollweide,
