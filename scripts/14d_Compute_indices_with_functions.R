...

{
  ...
  predicts_values <- predict(object = model, newdata = indices_df_raw)
  dim(predicts_values)
...
plot(PD_SR_residuals, col = colorRampPalette(rev(RColorBrewer::brewer.pal(11, "RdBu")))(200))
plot(MR_SR_residuals, col = colorRampPalette(rev(RColorBrewer::brewer.pal(11, "RdBu")))(200))
