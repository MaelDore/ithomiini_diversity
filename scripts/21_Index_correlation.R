...
all_indices_stack <- stack(sp.richness, sp.diversity, sp.mean.rarity, Faith.PD, FP, MPD, ring.richness, ring.diversity, mimicry.mean.rarity)
...
rownames(rho_uncorrected_pvalues_matrix) <- colnames(rho_uncorrected_pvalues_matrix) <- index_list
...
rownames(rho_pvalue_matrix) <- colnames(rho_pvalue_matrix) <- index_list # Provide names for rows and columns
...
rownames(tstat_df_matrix) <- colnames(tstat_df_matrix) <- index_list # Provide names for rows and columns
