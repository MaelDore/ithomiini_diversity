...
###### Script 21: Cropped maps based on HII ######

# Display cropped indices maps based on HII values
...
# Outputs:
# Maps of critical zones and refuges
  # Per quantiles 5 & 25%
...
load(file = "./outputs/Threat_maps/HII_cropped/HII_rank_indices_files.rds", version = "2") 
