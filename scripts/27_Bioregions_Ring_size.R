...
MPD <- readRDS(file = "./outputs/Indices_Maps/MPD.raster_Jaccard.80_contrasted.rds")
...
g1 <- ggplot(data = indices_df) +
  ...
  scale_fill_discrete(name = "Bioregions", labels = c("Central America", "East Ecuador", "East Peru", "Brazilian Atlantic Forest"), limits = c("#F8766D", "#7CAE00", "#00BFC4", "#C77CFF")) +
  
  theme(panel.background = element_rect(fill = "white"),
        legend.position = c(0.175, 0.83),
...
### 4/ Randomization "test" to see if we retrieve the same pattern ####
