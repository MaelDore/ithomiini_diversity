...
# Compute EM: continuous, incertitude (sd), binary, and committee averaging
...
# save(Jaccard.test.list_EM, file = paste0("../../outputs/Jaccard.test.list_EM.RData"), version = "2")
# saveRDS(Jaccard.test.list_EM, file = paste0("./input_data/Jaccard.test.list_EM.rds"), version = "2")
# save(TSS.test.list_EM, file = paste0("../../outputs/TSS.test.list_EM.RData"), version = "2")
# saveRDS(TSS.test.list_EM, file = paste0("./input_data/TSS.test.list_EM.rds"), version = "2")

save(Jaccard.test.list_EM, file = paste0("../../outputs/Jaccard.test.list_EM_",first(index_model_to_compute),"_",last(index_model_to_compute),".RData"), version = "2")
saveRDS(Jaccard.test.list_EM, file = paste0("./input_data/Jaccard.test.list_EM_",first(index_model_to_compute),"_",last(index_model_to_compute),".rds"), version = "2")
save(TSS.test.list_EM, file = paste0("../../outputs/TSS.test.list_EM_",first(index_model_to_compute),"_",last(index_model_to_compute),".RData"), version = "2")
saveRDS(TSS.test.list_EM, file = paste0("./input_data/TSS.test.list_EM_",first(index_model_to_compute),"_",last(index_model_to_compute),".rds"), version = "2")
